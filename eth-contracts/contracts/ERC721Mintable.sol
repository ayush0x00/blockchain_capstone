...
contract Ownable {
    ...
    modifier onlyOwner{
      require(msg.sender==_owner,"Not the owner of contracr");
      _;
    }
...
contract CustomERC721Token is ERC721Metadata("Ayush Tiwari Token","AT","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
